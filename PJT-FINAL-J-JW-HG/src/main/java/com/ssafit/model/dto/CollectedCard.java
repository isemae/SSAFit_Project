...
public class CollectedCard implements Serializable{
	...
	// 멤버 생성자
	public CollectedCard(int id, int userId, int exerciseId, int score, int tier, String collectedDate, String name) {
		super();
		this.id = id;
		this.userId = userId;
	...
	public String toString() {
		return "CollectedCard [id=" + id + ", userId=" + userId + ", exerciseId=" + exerciseId + ", score=" + score
				+ ", tier=" + tier + ", collectedDate=" + collectedDate + ", name=" + name + "]";
	}
